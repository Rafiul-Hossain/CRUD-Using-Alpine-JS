...
<body class="bg-gray-100" x-data="data">
    ...
    <div class="container mx-auto p-4">
        ...
        <form @submit.prevent="saveProduct()" id="createProductForm" class="mb-4 bg-white p-4 rounded shadow">
            ...
            <button type="submit" class="mt-2 px-4 py-2 bg-blue-500 text-blue rounded hover:bg-blue-600">Add Product</button>
        </form>
                ...
                <template x-for="product in products" :key="product.id">
                    <tr>
                        ...
                        <td class="p-2 flex gap-2">
                            <button @click="edit(product)" class="edit-btn px-2 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-500" data-id="1">Edit</button>
                            <button @click="deleteProduct(product)" class="delete-btn px-2 py-1 bg-red-500 text-white rounded hover:bg-red-500" data-id="1">Delete</button>
                        </td>
                    </tr>
                </template>
            </tbody>
            ...
            <div class="bg-white p-4 rounded shadow w-1/3">
                ...
                <form @submit.prevent id="editProductForm">
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <button @click="updateProduct()" type="submit" class="px-4 py-2 bg-blue-500 text-black rounded hover:bg-blue-600">Save</button>
                    </div>
                </form>
            </div>
        </div>
